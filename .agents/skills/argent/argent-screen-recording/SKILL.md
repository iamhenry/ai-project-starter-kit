...
description: Record a video of an iOS simulator or Android emulator/device screen using the argent `screen-recording` tools. Use when the user asks to record the screen, capture a video of a flow, interaction, or animation, produce a screen recording, or document app behavior as a video clip.
---
