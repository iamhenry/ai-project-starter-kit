...
description: Generate evidence-based Apple App Store screenshot captions, feature priorities, screenshot sequencing, and visual composition notes from a real product repository. Use when planning iPhone, iPad, or Mac screenshots or when the primary screenshot workflow needs a product-story brief. Inspect implementation and Git history so copy reflects what actually shipped.
---
...
4. Git commit history – use `git log --oneline --decorate` and path-specific history when useful to distinguish implemented features from user stories, plans, mocks, or abandoned work.
5. App Store metadata document – ensures messaging consistency.
